...
- I cannot function without a tiling window manager; in macOS, I use [Aerospace](/blog/2025-04-05-aerospace.md), and in Linux, Niri.
- I have too many repositories for my config file at this point
    - [nix-conf](https://github.com/theopn/nix-conf): NixOS, nix-darwin, and home-manager configurations, focusing on being minimal and functional, whatever that means.
    - [dotfiles](https://github.com/theopn/dotfiles): collection of all config files before I switched to Nix, though I try to keep them synced with any major Nix setup updates
    - [haunted-tiles](https://github.com/theopn/haunted-tiles): collection of scripts and config files for Sway and Niri (pre-Nix)
